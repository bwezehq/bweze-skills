...
```bash
# Frontend (Vercel)
npx @bweze/cli deployments list
npx @bweze/cli deployments status <id> [--sync] [--json]

# Edge function deploys
npx @bweze/cli logs function-deploy.logs [--limit <n>]
npx @bweze/cli functions list
```
...
npx @bweze/cli deployments status <id> --json
...
npx @bweze/cli functions deploy my-handler

# 2. Backend-side deploy log
npx @bweze/cli logs function-deploy.logs --limit 50
