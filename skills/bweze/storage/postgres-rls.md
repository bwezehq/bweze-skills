# Storage Row Level Security (RLS) for BWEZE
...
### Path helpers shipped with BWEZE
...
BWEZE exposes two write surfaces against the same `storage.objects` table:
