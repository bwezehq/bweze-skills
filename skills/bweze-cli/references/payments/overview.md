...
For app code, load the matching `bweze` app skill provider guide:

- `skills/bweze/payments/stripe.md`
- `skills/bweze/payments/razorpay.md`
...
- `sync` mirrors provider catalog/customers/subscriptions/transactions into BWEZE; it does not replace webhook delivery.
- Runtime checkout/order/subscription/customer portal calls belong in the app through `@bweze/sdk`, not CLI commands.
