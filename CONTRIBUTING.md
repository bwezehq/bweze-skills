# Contributing to BWEZE Agent Skills

Thank you for your interest in contributing to BWEZE Agent Skills! This document provides guidelines for contributing to this repository.
...
For BWEZE modules, keep documentation focused on the app or platform surface
being used:

- **`sdk-integration.md`**: Client-side SDK usage with `@bweze/sdk`
...
1. Create a directory under `skills/bweze/`
2. Add the required documentation files
3. Update the module reference table in `skills/bweze/SKILL.md`
