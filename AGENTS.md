...
This document helps AI coding agents work effectively with the BWEZE Agent Skills repository.
...
agent-skills/
├── skills/
│   └── bweze/           # BWEZE BaaS development skill
...
│   └── bweze-cli/       # BWEZE CLI project management
...
Most BWEZE skill modules use focused app-facing guides:

| File | Purpose | When to Use |
|------|---------|-------------|
| `sdk-integration.md` | App-facing SDK/API usage, usually through `@bweze/sdk` | Implementing features in user's app code |
...
The AI module is capability-based instead: start at `skills/bweze/ai/overview.md`,
...
1. Create a directory under `skills/bweze/` with the module name
...
4. Update the module reference table in `skills/bweze/SKILL.md`

For payments, keep app guides provider-specific (`payments/stripe.md`, `payments/razorpay.md`) and keep CLI routing/provider docs in `skills/bweze-cli/references/payments/`.
...
When working with BWEZE skills, remember:
